...
# [needed] replace this scatter plot
...
In order to truly understand if this model was appropriate, model diagnostics were run to prove the model was indeed valid. Additionally, the models were compared on a testing set where training occurred 80% of dates, and testing on the rest.
...
The model performs well on the training data but shows decrease in performance on the test set, given the higher testing MSE. This suggests slight overfitting, however, the model is reliable given the overall scale of the model.
...
1.  Continuous Dependent vVriables: average delay and flight volume
...
-   **Alexis Castaneda: Question 5, Distribution Plots, Correlation scatterplots, Model Diagnostics/Testing**

-   **Aparna Petluri: Question 5, Distribution Plots, Correlation scatterplots, Model Diagnostics/Testing**

-   **Gracelynne Mohan: Question 6,**
